<h1 class="mt-0 mb-4 lh-1">Создать кафедру</h1>

<form class="form" action="<?= base_url('/admin/department/create') ?>" method="post">
    <?= getCsrfField(); ?>
    ...
    <div class="form__group d-flex flex-column">
        <label class="form__label" for="name">Название кафедры</label>
    ...
    <div class="form__group d-flex flex-column">
        ...
        <input class="form__input" type="text" name="notes" id="notes" placeholder="" value="<?= old('notes') ?>">
        <?= getErrors('notes') ?>
    </div>
