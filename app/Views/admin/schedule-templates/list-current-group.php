...
<? if (isset($list["days"])): ?>
    <? foreach ($list["days"] as $day => $schedule): ?>
        <div class="block-list__item default-block default-block_padding mb-4">
            ...
            <? foreach ($schedule as $k => $weekParity): ?>
                <h3 class="block-list__title text-center mb-2"><?= $data['weekParity'][$k] ?></h3>
                <div class="d-grid grid-col-7 align-items-center justify-center mb-2 pb-2 border-bottom-1">
                    ...
                    <p class="block-list__title text-center">Активность</p>
                    <p class="block-list__title text-center">Функции</p>
                </div>
                <? foreach ($weekParity as $item): ?>
                    <div class="d-grid grid-col-7 align-items-center mb-2 pb-2 <?= $item["id"] !== array_last($weekParity)["id"] ? "border-bottom-1" : "" ?>">
                        ...
                        <div class="d-flex justify-center">
                            <p class="block-list__title text-center"><?= $item["is_active"] ? "✅" : "❌" ?></p>
                        </div>
                        <div class="d-flex flex-column align-items-center gap-2">
                            <a class="button d-flex align-items-center justify-center" href="<?= base_url("/admin/schedules/semester/{$semesterId}/group/{$groupId}/edit/" . $item["id"]) ?>" title="Редактировать">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                    <path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"></path>
                                </svg>
                            </a>
                            <a class="button button_danger d-flex align-items-center justify-content-center" href="<?= base_url("/admin/schedules/semester/{$semesterId}/group/{$groupId}/delete/" . $item["id"]) ?>" title="Удалить">
