<? if (empty($data)): ?>
    <div class="block-list d-flex justify-center text-center">
        <div class="block-list__item default-block default-block_padding text-center">
            <p class="block-list__text">Нет дисциплин</p>
        </div>
    </div>
<? else: ?>
            ...
            <div class="block-list__item default-block default-block_padding">
                ...
                <? if ($item["description"]): ?>
                    <div class="d-flex align-items-center justify-content-between mb-2 gap-2">
                        <svg class="fs-0" fill="currentColor" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="block-list__footer">
                    <a class="button d-flex align-items-center justify-content-center mb-2" href="<?= base_url('/admin/subjects/edit/' . $item["id"]) ?>">
                    ...
                    <a class="button button_danger d-flex align-items-center justify-content-center" href="<?= base_url('/admin/subjects/delete/' . $item["id"]) ?>">
