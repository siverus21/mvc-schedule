<? if (empty($data)): ?>
    <div class="block-list d-flex justify-center text-center">
        <div class="block-list__item default-block default-block_padding text-center">
            <p class="block-list__text">Нет типов оборудования</p>
        </div>
    </div>
<? else: ?>
        ...
        <? foreach ($data as $item): ?>
            <div class="block-list__item default-block default-block_padding">
                ...
                <div class="block-list__footer">
                    <a class="button d-flex align-items-center justify-content-center mb-2" href="<?= base_url('/admin/equipment-types/edit/' . $item["id"]) ?>">
                    ...
                    <a class="button button_danger d-flex align-items-center justify-content-center" href="<?= base_url('/admin/equipment-types/delete/' . $item["id"]) ?>">
